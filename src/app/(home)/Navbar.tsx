...
const NavbarItem = ({
    ...
    return(
        <Button
            asChild    // tells that the children link will now be used as component
            variant="outline"
    ...
    return(
        <nav className="h-20 flex border-b justify-between font-medium bg-white">
            <Link href="/" className="pl-6 flex items-center">
                <span className={cn("text-5xl font-semibold" , poppins.className)}>E-hub</span>
            </Link>
            ...
            {/* to render menu icon in small devices */}
